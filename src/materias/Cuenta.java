...
//        System.out.println(al.path.getAbsolutePath());
        ...
        int creditos, creditAcum;
        creditos = Integer.valueOf(al.LeerLinea());
        creditAcum = Integer.valueOf(al.LeerLinea());
        al.CerrarLectura();
        Alumno.Alumno(alu[0].toString(), alu[1].toString(), alu[2].toString(),
                alu[3].toString(), alu[4].toString(), alu[5].toString(),
                alu[6].toString(), alu[7].toString(), creditos,
                creditAcum);
...
//            listaAprobadas.addElement(line);
    ...
    private void initComponents() {
        ...
        getContentPane().add(jButVerHorarios, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 110, 150, -1));
