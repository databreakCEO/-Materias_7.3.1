...
//                    System.out.print(Materia.lista.get(j).nombreMat+" ");
                    creditosMat[index++] = Materia.lista.get(j).costo;
//                    System.out.print(Materia.lista.get(j).costo);
                    break;
                }
            }
...
//        OrdenarXHorasEscolares(sc, 0, sc.size() - 1, 0);
    ...
    public void crearHorarios() {
        try {
            ...
            try {
//                for (int i = 0; i < listaElegidos.size(); i++) {
//                    System.out.println(listaElegidos.get(i));
//                }
//                System.out.println("");
...
//                colorCeldas.addCelda(i, 0, colores[index]);
//                colorCeldas.addCelda(i, 1, colores[index]);
//                colorCeldas.addCelda(i, 2, colores[index++]);
            }
        }
        if (suma > 36) {
